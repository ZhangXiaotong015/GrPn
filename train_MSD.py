...
from datasets.dataset import Dataset_MSD_train, Dataset_MSD_val
...
class MSDConfig(Config):
    ...
    # Dataset name
    dataset = '' #'MSD'
    data_root = '' #'/data1/xzhang2/liver_couinaud_segmentation/data/MSD_Couinaud'
...
def main():
    ...
    # Initialize datasets
    training_dataset = Dataset_MSD_train(config, name='training')
    val_dataset = Dataset_MSD_val(config, name='validation')
    ...
    training_loader = DataLoader(training_dataset,
                            ...
                            collate_fn=MSD_collate_train,
                            pin_memory=True
                            )
    val_loader = DataLoader(val_dataset,
                            batch_size=config.batch_size,
                            num_workers=0,#config.input_threads,
                            collate_fn=MSD_collate_val,
                            pin_memory=True
                            )
